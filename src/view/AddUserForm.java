    ...
    public AddUserForm(UserController userController, DepartmentController departmentController) {
        ...
        addUserButton.addActionListener(e -> {
            ...
            if (type.equals("Admin")) {
                ...
                if (userController.addAdmin(cpf, name, numberOfTuition, birthdate, password, department)) {
                    JOptionPane.showMessageDialog(panel,
                ...
                if(userController.addMember(cpf, name, numberOfTuition, birthdate, department)) {
                    JOptionPane.showMessageDialog(panel,
